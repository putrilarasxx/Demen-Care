    ...
    <form action="<?= site_url('Appointment/index') ?>" method="get">
        <div class="d-flex flex-wrap gap-3">
            <div class="flex-fill">
                ...
                <input class="form-control" type="text" name="nama_pasien" value="<?= $user['first_name'] ?>" readonly />
            </div>
            <div class="flex-fill">
                    ...
                    <div class="modal-body">
                        <div class="row gap-2">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="nama_pasien" name="nama_pasien" value="<?= $user['first_name'] ?>" readonly />
                            </div>
                            <div class="col">
                            ...
                            <form method="post" action="<?= site_url('Appointment/ubah') ?>">
                                <div class="modal-body">
                                    <div class="row gap-2">
                                        ...
                                        <div class="d-none">
                                            <label for="id_app" class="form-label">ID Akun</label>
